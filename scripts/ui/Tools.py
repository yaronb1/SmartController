...
import scripts.detectors.handLandmarks
...
class HandCropper():
    ...
    def save_coordinates(self, coordinates):
        ...
        with open('/button_variables/ac_lights.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
...
class IsolateColor:
    ...
    def save_image(self,value):
        ...
        if self.transparent:
            self.img_result = black_to_transparent(self.img_result)
...
def black_to_transparent(img,w_t_t=False):
    # read the image
    image_bgr = img
...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/yaron/Pictures/Screenshot from 2023-02-25 20-37-23.png')
    cv2.imshow('or', img)
    # img = cv2.resize(img,(300,400))
    # IsolateColor(img = img)
    #
    # cv2.waitKey(0)