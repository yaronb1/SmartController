...
if __name__ == "__main__":
    ...
    #c.rgb_bulb(id= c.cloud_devices['bar top'], mode = 'colour', data = {"h":150, "s":870, "v":1000})
    c.get_device_properties(c.cloud_devices['bar top'])
    #c.rgb_bulb(id = c.cloud_devices['bar top'], mode = 'white', data = 10)
